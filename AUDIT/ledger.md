...
**Open: 55 | done: 37 | blocked: 0 | total: 92** (S0 7, S1 31, S2 47, S3 7)
...
| [0039](#0039) | S1 | M1 | `chatbox.swift:2406` | Request log records no time, peer, principal or route context; credential issue/revoke unaudited [also: Request target control bytes are echoed into logs and the 404 body (log injection)] | bug | **AUDIT** | node1 | phase-B/L3-line-level,L7-ops |
