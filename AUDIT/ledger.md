...
**Open: 74 | done: 17 | blocked: 0 | total: 91** (S0 7, S1 31, S2 46, S3 7)
...
| [0091](#0091) | S2 | M1 | `AUDIT/mutate.sh` | The mutation matrix silently skips cells whose anchor no longer matches the code, and cannot be reproduced from a clone | test | **AUDIT** | node1 | audit/0034 run |
