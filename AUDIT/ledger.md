...
**Open: 78 | done: 11 | blocked: 0 | total: 89** (S0 7, S1 31, S2 44, S3 7)
...
| [0015](#0015) | S1 | M1 | `chatbox.swift:896,373` | `@unchecked Sendable` on Chatbox and Store suppresses all concurrency checking | unsafe | **AUDIT** | node1 | L2 |
