...
**Open: 52 | done: 40 | blocked: 0 | total: 92** (S0 7, S1 31, S2 47, S3 7)
...
| [0040](#0040) | S1 | M1 | `chatbox.swift:2431` | Connections refused at the ceiling get no idle deadline and are not counted, so stalled TLS handshakes accumulate without bound | unsafe | **AUDIT** | node1 | phase-B/L2-server-http |
